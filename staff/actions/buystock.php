...
error_reporting(E_ERROR | E_WARNING | E_PARSE);
  ...
  //Transaction Queries:
    ...
    //All Transactions:
      ...
      $transQ = mysql_query("INSERT INTO transactions (ID, Description, Company_Acquiring, Company_Selling, Amount) VALUES (NULL, 'Stock Purchase', '$companyName', 'Bank', $total)");
    ...
    $transCT = mysql_query("INSERT INTO $cTable (ID, Transaction_ID, Company_Acquiring, Company_Selling, Description, Previous_Balance, New_Balance, Amount) VALUES (NULL, $transID , '$companyName', 'Bank', 'Stock Purchase', $prevBal, $balance, $total)");

  	if($purchase && $transferTo && $transferFrom && $transQ && $transCT){
  		header("location:../bank.php?purchase=e1#bStock");
        }
        else
        {
            die (mysql_error());
            header("location:../bank.php?purchase=error#bStock");
        }
