...
//Query Deposit f2Trans
$depositQuery = "INSERT INTO f2Trans (ID, Transaction_ID, Description, Company_Acquiring, Company_Selling, Amount, Previous_Balance, New_Balance, Type) VALUES (NULL, '$newID', 'Deposit', '$from', '$to', '$amount', '$prevBal', '$newBal', 'Deposit')";
...
if($deposit && $cbTransQuery && $balanceQuery){
            header("location:../bankF2.php?deposit=e1#bTrans");
        }
        else
        {
            die (mysql_error());
            header("location:../bankF2.php?deposit=error#bTrans");
        }
