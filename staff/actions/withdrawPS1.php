...
//Query Withdrawal ps1Trans
$withdrawQuery = "INSERT INTO ps1Trans (ID, Transaction_ID, Description, Company_Acquiring, Company_Selling, Amount, Previous_Balance, New_Balance, Type) VALUES (NULL, '$newID', 'Withdrawal', '$from', '$to', '$amount', '$prevBal', '$newBal', 'Withdrawal')";
...
if($withdraw){
            header("location:../bankPS1.php?withdraw=e1#bTrans");
        }
        else
        {
            die (mysql_error());
            header("location:../bankPS1.php?withdraw=error#bTrans");
        }
